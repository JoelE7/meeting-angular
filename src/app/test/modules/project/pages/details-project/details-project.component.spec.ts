...
describe('DetailsProjectComponentConLogin', () => {
  ...
  xit('si el proyecto está vinculado a un repo de github o gitlab que se traiga las métricas : getMetricByProject()', async() => {
  ...
  xit('si el proyecto no está vinculado a un repo de github o gitlab que no traiga las métricas : getMetricByProject()', async() => {
